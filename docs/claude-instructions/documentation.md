...
change (the same discipline the changelog follows). In particular:

- **New** feature, widget, listener, config field, or tab → update the relevant `features/` /
  `architecture/` doc, and add a line to the `docs/README.md` index if you created a new page.
